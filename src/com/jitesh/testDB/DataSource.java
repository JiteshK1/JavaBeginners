...
public class DataSource {
    ...
    public static final String QUERY_PREVIEW_SONG_INFO =  "SELECT " + COLUMN_ARTIST_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = ?";
    ...
    public boolean open(){
        try {
            ...
            querySongInfoView=conn.prepareStatement(QUERY_PREVIEW_SONG_INFO);
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        ResultSet resultSet = statement.executeQuery(sb.toString())){
            ...
            System.out.println("Went wrong in "+e.getMessage());
            return null;
        }
    }
  ...
  try (Statement statement =conn.createStatement();
    ...
    public void queryMetaData(){
        ...
        ResultSet resultSet=statement.executeQuery(sql)
            ...
            for (int i = 1; i <=numColumns ; i++) {
                System.out.printf("Colums %d in the songs are tables name %s\n",i,metaData.getColumnName(i));
            }
    ...
    public int getCount(String table){
        ...
        ResultSet resultSet = statement.executeQuery(sql)){
            ...
            System.out.println("Count is "+count+" min is "+min);
            return count;
        }catch (SQLException e){
            System.out.println(e.getMessage());
            return -1;
    ...
    try {
        ...
        try {
            ...
            System.out.println("MEssed up "+e.getMessage());
    }
    }
    }
}
